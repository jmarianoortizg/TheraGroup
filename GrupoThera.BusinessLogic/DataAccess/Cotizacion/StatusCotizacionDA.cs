...
namespace GrupoThera.BusinessLogic.DataAccess.Cotizacion
{
    public class StatusCotizacionDA : EntityRepositoryBase<StatusCotizacion, GrupoTheraContext>, IStatusCotizacion
    {
        #region Methods 
